...
export default function AdminLayout({
  ...
  if (isAuthRoute) {
    return <div className="bg-admin-bg min-h-[100dvh] flex items-center justify-center p-4 font-sans text-admin-text">{children}</div>;
  }

  if (!isInitialized) {
    return (
      <div className="min-h-[100dvh] flex items-center justify-center bg-admin-bg font-sans">
  ...
  return (
    <div className="admin-theme bg-admin-bg font-sans text-admin-text h-[100dvh] w-full overflow-hidden flex relative">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        ...
        <main className="flex-1 w-full min-w-0 overflow-y-auto overflow-x-hidden flex flex-col bg-white pb-[calc(4rem+env(safe-area-inset-bottom))] md:pb-0">
          {children}
        </main>
      </div>
