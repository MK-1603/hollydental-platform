  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-8 pb-24">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h2 className="text-[24px] font-bold text-gray-900 tracking-tight">Doctors</h2>
          <p className="text-[14px] text-gray-500 mt-1">Manage clinical staff, working hours, and performance metrics.</p>
        </div>
        <button 
