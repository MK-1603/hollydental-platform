...
import { X, MapPin, Clock, Phone, ShieldCheck, Award, Star, CheckCircle2, AlertTriangle } from "lucide-react";
...
export default function BookingPage() {
  ...
  const handleClose = () => {
    ...
    // Step 8 is confirmation, so no need to warn
    if (currentStep < 8) {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-[#FAFBFC] flex flex-col lg:flex-row overflow-y-auto lg:overflow-hidden relative">
      ...
      {/* Abort Modal */}
      {showAbortModal && (
        <div className="fixed inset-0 z-[100] bg-navy/90 backdrop-blur-sm flex flex-col items-center justify-center p-4">
